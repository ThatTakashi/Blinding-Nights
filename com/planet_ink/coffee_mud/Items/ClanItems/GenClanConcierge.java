 ...
 */
public class GenClanConcierge extends StdClanConcierge
{
	@Override
	public String ID()
	{
		return "GenClanConcierge";
	}

	protected String	readableText	= "";

	public GenClanConcierge()
	{
		super();
		setName("a generic clan concierge ribbon");
		setDisplayText("a generic clan concierge ribbon sits here.");
		setDescription("");
	...
	public String[] getStatCodes()
	{
		if (codes != null)
			return codes;
		final String[] MYCODES = CMProps.getStatCodesList(GenClanConcierge.MYCODES, this);
	...
	{
		if (!(E instanceof GenClanConcierge))
			return false;
