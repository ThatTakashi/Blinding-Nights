 ...
 */
public class GenClanTabbard extends StdClanTabbard
{
	@Override
	public String ID()
	{
		return "GenClanTabbard";
	}

	protected String	readableText	= "";

	public GenClanTabbard()
	{
		super();
		setName("a generic clan tabbard");
		setDisplayText("a generic clan tabbard sits here.");
		setDescription("");
	...
	public String[] getStatCodes()
	{
		if (codes != null)
			return codes;
		final String[] MYCODES = CMProps.getStatCodesList(GenClanTabbard.MYCODES, this);
	...
	{
		if (!(E instanceof GenClanTabbard))
			return false;
