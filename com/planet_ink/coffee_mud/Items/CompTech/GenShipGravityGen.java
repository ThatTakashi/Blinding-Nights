...
*/
public class GenShipGravityGen extends StdShipGravityGen
{
	@Override
	public String ID()
	{
		return "GenShipGravityGen";
	}

	public GenShipGravityGen()
	{
		super();
		setName("a generic gravity generator");
		setDisplayText("a generic gravity generator sits here.");
		setDescription("");
	}
	...
	public String[] getStatCodes()
	{
		if(codes!=null)
			return codes;
		final String[] MYCODES=CMProps.getStatCodesList(GenShipGravityGen.MYCODES,this);
	...
	{
		if(!(E instanceof GenShipGravityGen))
			return false;
