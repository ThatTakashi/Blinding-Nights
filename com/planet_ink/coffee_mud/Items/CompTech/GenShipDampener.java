...
*/
public class GenShipDampener extends StdShipDampener
{
	@Override
	public String ID()
	{
		return "GenShipDampener";
	}

	public GenShipDampener()
	{
		super();
		setName("a generic inertial dampener");
		setDisplayText("a generic inertial dampener sits here.");
		setDescription("");
	}
	...
	public String[] getStatCodes()
	{
		if(codes!=null)
			return codes;
		final String[] MYCODES=CMProps.getStatCodesList(GenShipDampener.MYCODES,this);
	...
	{
		if(!(E instanceof GenShipDampener))
			return false;
