...
*/
public class GenBagOfEndlessness extends BagOfEndlessness
{
	@Override
	public String ID()
	{
		return "GenBagOfEndlessness";
	}

	protected String	readableText	= "";

	public GenBagOfEndlessness()
	{
		super();
		setName("a strange bag");
		basePhyStats.setWeight(2);
		setDisplayText("a strange bag sits here.");
		setDescription("");
		baseGoldValue=5;
		capacity=1;
		recoverPhyStats();
	...
	public String[] getStatCodes()
	{
		if(codes!=null)
			return codes;
		final String[] MYCODES=CMProps.getStatCodesList(GenBagOfEndlessness.MYCODES,this);
	...
	{
		if(!(E instanceof GenBagOfEndlessness))
			return false;
