...
*/
public class GenBagOfHolding extends BagOfHolding
{
	@Override
	public String ID()
	{
		return "GenBagOfHolding";
	}

	protected String	readableText	= "";

	public GenBagOfHolding()
	{
		super();
		setName("a strange generic bag");
		setDisplayText("a strange generic bag sits here.");
		recoverPhyStats();
	}
	...
	public String[] getStatCodes()
	{
		if(codes!=null)
			return codes;
		final String[] MYCODES=CMProps.getStatCodesList(GenBagOfHolding.MYCODES,this);
	...
	{
		if(!(E instanceof GenBagOfHolding))
			return false;
