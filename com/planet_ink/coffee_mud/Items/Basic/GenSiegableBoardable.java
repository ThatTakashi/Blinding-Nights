...
*/
public class GenSiegableBoardable extends StdSiegableBoardable
{
	@Override
	public String ID()
	{
		return "GenSiegableBoardable";
	}
	...
	public String[] getStatCodes()
	{
		if(codes!=null)
			return codes;
		final String[] MYCODES=CMProps.getStatCodesList(GenSiegableBoardable.MYCODES,this);
	...
	{
		if(!(E instanceof GenSiegableBoardable))
			return false;
		...
		final Area eA = ((GenSiegableBoardable)E).getArea();
		if(eA==null)
			return getArea()==null;
