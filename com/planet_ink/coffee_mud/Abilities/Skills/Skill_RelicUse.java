...
*/
public class Skill_RelicUse extends StdSkill implements Wand.WandUsage
{
	@Override
	public String ID()
	{
		return "Skill_RelicUse";
	}

	private final static String localizedName = CMLib.lang().L("Relics");
