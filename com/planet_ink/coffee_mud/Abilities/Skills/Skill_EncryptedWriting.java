...
public class Skill_EncryptedWriting extends Skill_Write
{
	...
	public String ID()
	{
		return "Skill_EncryptedWriting";
	}

	private final static String	localizedName	= CMLib.lang().L("Encrypted Writing");
	...
	private static final String[]	triggerStrings	= I(new String[] { "ENCRYPTEDWRITING", "ENCRYPTWRITE", "EWRITE", "EWR" });
