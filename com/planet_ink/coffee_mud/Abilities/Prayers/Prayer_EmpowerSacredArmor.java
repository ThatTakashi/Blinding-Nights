...
*/
public class Prayer_EmpowerSacredArmor extends Prayer
{

	@Override
	public String ID()
	{
		return "Prayer_EmpowerSacredArmor";
	}

	private final static String localizedName = CMLib.lang().L("Empower Sacred Armor");
	...
	public boolean invoke(final MOB mob, final List<String> commands, final Physical givenTarget, final boolean auto, final int asLevel)
	{
		...
		if(CMLib.flags().isGood(target)||CMLib.flags().isEvil(target))
		{
			mob.tell(L("You can not empower that repulsive armor."));
			return false;
		}
