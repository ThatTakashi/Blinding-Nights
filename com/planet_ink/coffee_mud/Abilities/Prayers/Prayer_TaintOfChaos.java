...
*/
public class Prayer_TaintOfChaos extends Prayer
{
	@Override
	public String ID()
	{
		return "Prayer_TaintOfChaos";
	}

	private final static String	localizedName	= CMLib.lang().L("Taint of Chaos");
	...
	private final static String	localizedStaticDisplay	= CMLib.lang().L("(Taint of Chaos)");
	...
	public void unInvoke()
	{
		...
		if(canBeUninvoked())
			mob.tell(L("Your taint of chaos fades."));
	}
	...
	public boolean invoke(final MOB mob, final List<String> commands, final Physical givenTarget, final boolean auto, final int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?L("<T-NAME> <T-IS-ARE> cursed with the taint of chaos!"):L("^S<S-NAME> @x1 for <T-YOUPOSS> need to be tainted with chaos!^?",prayWord(mob)));
