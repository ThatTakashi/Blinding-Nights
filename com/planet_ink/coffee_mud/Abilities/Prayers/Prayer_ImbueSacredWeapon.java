...
*/
public class Prayer_ImbueSacredWeapon extends Prayer_ImbueShield
{

	@Override
	public String ID()
	{
		return "Prayer_ImbueSacredWeapon";
	}

	private final static String	localizedName	= CMLib.lang().L("Imbue Sacred Weapon");
	...
	{
		if(CMLib.flags().isEvil(target)||CMLib.flags().isGood(target))
		{
