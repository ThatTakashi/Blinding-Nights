...
*/
public class Prayer_ImbueModestWeapon extends Prayer_ImbueShield
{

	@Override
	public String ID()
	{
		return "Prayer_ImbueModestWeapon";
	}

	private final static String	localizedName	= CMLib.lang().L("Imbue Modest Weapon");
	...
	public long flags()
	{
		return Ability.FLAG_NOORDERING|Ability.FLAG_MODERATE;
	}
