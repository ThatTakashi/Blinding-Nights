...
*/
public class Prayer_ImbueJustWeapon extends Prayer_ImbueShield
{

	@Override
	public String ID()
	{
		return "Prayer_ImbueJustWeapon";
	}

	private final static String	localizedName	= CMLib.lang().L("Imbue Just Weapon");
	...
	{
		mob.location().show(mob,targetI,null,CMMsg.MSG_OK_VISUAL,L("<T-NAME> glow(s) justly bright!"));
