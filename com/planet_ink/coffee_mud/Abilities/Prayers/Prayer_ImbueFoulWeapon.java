...
*/
public class Prayer_ImbueFoulWeapon extends Prayer_ImbueShield
{

	@Override
	public String ID()
	{
		return "Prayer_ImbueFoulWeapon";
	}

	private final static String	localizedName	= CMLib.lang().L("Imbue Foul Weapon");
	...
	{
		mob.location().show(mob,targetI,null,CMMsg.MSG_OK_VISUAL,L("<T-NAME> glow(s) chaotically bright!"));
