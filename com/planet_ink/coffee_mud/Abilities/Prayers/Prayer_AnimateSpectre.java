...
public class Prayer_AnimateSpectre extends Prayer
{
	...
	public boolean invoke(final MOB mob, final List<String> commands, final Physical givenTarget, final boolean auto, final int asLevel)
	{
		...
		final String undeadDesc=L("In undeath, it become a nearly transparent luminous incorporeal spirit.");
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),
					auto?"":L("^S<S-NAME> @x1 to animate <T-NAMESELF> as a spectre.^?",prayForWord(mob)));
