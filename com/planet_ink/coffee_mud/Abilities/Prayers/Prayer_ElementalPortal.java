...
*/
public class Prayer_ElementalPortal extends Prayer_MalignedPortal
{

	@Override
	public String ID()
	{
		return "Prayer_ElementalPortal";
	}

	private final static String localizedName = CMLib.lang().L("Elemental Portal");
