...
public class Prayer_RestoreSmell extends Prayer implements MendingSkill
{
	...
	public boolean invoke(final MOB mob, final List<String> commands, final Physical givenTarget, final boolean auto, final int asLevel)
	{
		...
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?L("A visible glow surrounds the nose of <T-NAME>."):L("^S<S-NAME> @x1 for <T-NAMESELF> to be able to smell the roses.^?",prayWord(mob)));
