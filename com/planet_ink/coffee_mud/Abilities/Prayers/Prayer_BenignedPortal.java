...
*/
public class Prayer_BenignedPortal extends Prayer_MalignedPortal
{

	@Override
	public String ID()
	{
		return "Prayer_BenignedPortal";
	}

	private final static String localizedName = CMLib.lang().L("Benigned Portal");
	...
	protected void fixPlanarMob(final MOB M)
	{
		...
		{
			final Behavior B=CMClass.getBehavior("GoodExecutioner");
			M.addBehavior(B);
		}
	}
}
