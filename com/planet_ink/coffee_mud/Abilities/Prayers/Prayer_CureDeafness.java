...
public class Prayer_CureDeafness extends Prayer implements MendingSkill
{
	...
	private final static String localizedName = CMLib.lang().L("Cure Deafness");
	...
	public boolean invoke(final MOB mob, final List<String> commands, final Physical givenTarget, final boolean auto, final int asLevel)
	{
		...
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?L("A visible glow surrounds <T-NAME>."):L("^S<S-NAME> @x1 for <T-NAMESELF> to hear <S-HIS-HER> prayer.^?",prayWord(mob)));
