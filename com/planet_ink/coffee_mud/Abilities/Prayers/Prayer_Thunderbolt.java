...
public class Prayer_Thunderbolt extends Prayer
{
	...
	public boolean invoke(final MOB mob, final List<String> commands, final Physical givenTarget, final boolean auto, final int asLevel)
	{
		...
		if(success)
		{
			...
			final CMMsg msg=CMClass.getMsg(mob,target,newOne,verbalCastCode(mob,target,auto),
					L(auto?"<T-NAME> is filled with a holy charge!":
						"^S<S-NAME> @x1 to strike down <T-NAMESELF>!^?",prayForWord(mob))+CMLib.protocol().msp("lightning.wav",40));
