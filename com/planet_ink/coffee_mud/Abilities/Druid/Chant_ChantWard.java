...
public class Chant_ChantWard extends Chant
{
	...
	public String ID()
	{
		return "Chant_ChantWard";
	}

	private final static String localizedName = CMLib.lang().L("Chant Ward");
	...
	private final static String localizedStaticDisplay = CMLib.lang().L("(Chant Ward)");
	...
	public void unInvoke()
	{
		...
		if(canBeUninvoked())
			mob.tell(L("Your ward against chants fades."));
	...
	public boolean invoke(final MOB mob, final List<String> commands, final Physical givenTarget, final boolean auto, final int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?L("<T-NAME> <T-IS-ARE> protected from chants."):L("^S<S-NAME> chant(s) for a ward against chanting around <T-NAMESELF>.^?"));
