...
*/
public class FoodPreserving extends CommonSkill
{
	@Override
	public String ID()
	{
	...
	private static final String[]	triggerStrings	= I(new String[] { "FOODPRESERVING", "FOODPRESERVE", "FPRESERVING", "FPRES" });
	...
	public FoodPreserving()
	{
		super();
		displayText=L("You are preserving...");
		verb=L("preserving");
	}
	...
	public void unInvoke()
	{
		if(canBeUninvoked())
		{
			...
			&&(found!=null))
			{
				...
				if(mob!=null)
					commonEmote(mob,L("<S-NAME> mess(es) up preserving @x1.",found.name()));
			}
		}
		super.unInvoke();
	}
	...
	public boolean invoke(final MOB mob, final List<String> commands, final Physical givenTarget, final boolean auto, final int asLevel)
	{
		...
		if(!super.invoke(mob,commands,givenTarget,auto,asLevel))
			return false;
		verb=L("preserving @x1",target.name());
		...
		final CMMsg msg=CMClass.getMsg(mob,target,this,getActivityMessageType(),L("<S-NAME> start(s) preserving <T-NAME>."));
