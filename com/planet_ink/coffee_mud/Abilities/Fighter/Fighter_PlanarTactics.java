...
*/
public class Fighter_PlanarTactics extends Fighter_FieldTactics
{
	@Override
	public String ID()
	{
		return "Fighter_PlanarTactics";
	}

	private final static String localizedName = CMLib.lang().L("Planar Tactics");
