...
*/
public class Proficiency_Bow extends Proficiency_Weapon
{
	@Override
	public String ID()
	{
		return "Proficiency_Bow";
	}

	private final static String	localizedName	= CMLib.lang().L("Bow Proficiency");
	...
	protected String getWeaponMask()
	{
		...
		{
			super.getWeaponMask();
			weaponZappermask += " -WEAPONAMMO +arrow +arrows ";
		}
