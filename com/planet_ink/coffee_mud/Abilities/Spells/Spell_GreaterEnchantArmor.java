...
*/
public class Spell_GreaterEnchantArmor extends Spell
{

	@Override
	public String ID()
	{
		return "Spell_GreaterEnchantArmor";
	}

	private final static String localizedName = CMLib.lang().L("Greater Enchant Armor");
	...
	public boolean invoke(final MOB mob, final List<String> commands, final Physical givenTarget, final boolean auto, final int asLevel)
	{
		...
		{
			mob.tell(mob,target,null,L("You can't enchant <T-NAME> with a Greater Enchant Armor spell!"));
			return false;
		}
