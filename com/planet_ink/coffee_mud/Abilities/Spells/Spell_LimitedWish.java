...
*/
public class Spell_LimitedWish extends Spell_Wish
{

	@Override
	public String ID()
	{
		return "Spell_LimitedWish";
	}

	private final static String localizedName = CMLib.lang().L("Limited Wish");
	...
	{
		final int cost=super.getXPCOSTAdjustment(mob, xpLoss);
		return cost * 2;
	}
