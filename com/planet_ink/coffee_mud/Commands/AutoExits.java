...
public class AutoExits extends StdCommand
{
		...
		throws java.io.IOException
	{
		...
		if((!mob.isAttributeSet(MOB.Attrib.AUTOEXITS) && (parm.length()==0))||(parm.equalsIgnoreCase("ON")))
		{
			mob.setAttribute(MOB.Attrib.AUTOEXITS,true);
			mob.tell(L("Autoexits has been turned on."));
		}
		else
		if((mob.isAttributeSet(MOB.Attrib.AUTOEXITS) && (parm.length()==0))||(parm.equalsIgnoreCase("OFF")))
		{
