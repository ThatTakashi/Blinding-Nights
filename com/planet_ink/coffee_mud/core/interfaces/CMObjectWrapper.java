...
*/
/**
 * A fake/temporary wrapper for an existing cmobject
 * @see com.planet_ink.coffee_mud.core.interfaces.CMObject
 * @author Bo Zimmerman
 *
 */
public interface CMObjectWrapper extends CMObject
{
	/**
