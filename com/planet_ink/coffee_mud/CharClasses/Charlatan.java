...
public class Charlatan extends StdCharClass
{
	...
	public void initializeClass()
	{
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(),9,"Spell_Prestidigitation",true);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(),30,"MasterCostuming",false,new XVector<String>("Costuming(50)"));
		// 30 -- cheaper skills
	}
