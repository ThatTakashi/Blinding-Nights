...
public class Diviner extends SpecialistMage
{
	...
	public void initializeClass()
	{
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(),3,"Spell_KnowProvince",25,true);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(),9,"Spell_SolveMaze",25,true);
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(),14,"Spell_HearThoughts",25,"",true,SecretFlag.PUBLIC,CMParms.parseSemicolons("Spell_Telepathy",true),"");
