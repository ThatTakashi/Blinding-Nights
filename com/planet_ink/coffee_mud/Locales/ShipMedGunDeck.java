...
*/
public class ShipMedGunDeck extends WoodenDeck
{
	@Override
	public String ID()
	{
		return "ShipMedGunDeck";
	}

	protected Ability capacityA;

	public ShipMedGunDeck()
	{
		super();
		name="the ship deck";
		...
		if(capacityA!=null)
		{
			capacityA.setMiscText("items=20 weight=600 siegeweapons=2");
	...
	{
		final ShipMedGunDeck R = (ShipMedGunDeck)super.copyOf();
		R.capacityA=CMClass.getAbility("Prop_ReqCapacity");
		R.capacityA.setMiscText("items=20 weight=600 siegeweapons=2");
	...
	{
		final ShipMedGunDeck R = (ShipMedGunDeck)super.newInstance();
		R.capacityA=CMClass.getAbility("Prop_ReqCapacity");
		R.capacityA.setMiscText("items=20 weight=600 siegeweapons=2");
		R.capacityA.setAffectedOne(R);
		R.capacityA.makeNonUninvokable();
