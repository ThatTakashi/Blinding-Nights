...
*/
public class ShipDeck extends WoodenDeck
{
	@Override
	public String ID()
	{
	...
	public ShipDeck()
	{
		...
		if(capacityA!=null)
		{
			capacityA.setMiscText("items=20 weight=300 siegeweapons=0");
	...
	{
		final ShipDeck R = (ShipDeck)super.copyOf();
		R.capacityA=CMClass.getAbility("Prop_ReqCapacity");
		R.capacityA.setMiscText("items=20 weight=300 siegeweapons=0");
	...
	{
		final ShipDeck R = (ShipDeck)super.newInstance();
		R.capacityA=CMClass.getAbility("Prop_ReqCapacity");
		R.capacityA.setMiscText("items=20 weight=300 siegeweapons=0");
		R.capacityA.setAffectedOne(R);
		R.capacityA.makeNonUninvokable();
