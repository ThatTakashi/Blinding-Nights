...
public class Halfling extends StdRace
{
	...
	private final String[]	culturalAbilityNames			= { "Elvish", "Cooking", "Proficiency_Sling", "Fighter_FastSlinging" };
	private final int[]		culturalAbilityProficiencies	= { 25, 75, 25, 25 };
