...
*/
public class Treant extends StdRace
{
	@Override
	public String ID()
	{
	...
	private final static String localizedStaticName = CMLib.lang().L("Treant");
	...
	private static final int[] parts={0 ,2 ,2 ,1 ,1 ,8 ,8 ,1 ,2 ,2 ,1 ,0 ,1 ,1 ,0 ,0 };
	...
	private final int[]	agingChart	= { 0, 10, 20, 50, 100, 250, 850, 2150, 10160 };
