...
*/
public class Troglodyte extends StdRace
{
	@Override
	public String ID()
	{
	...
	private final static String localizedStaticName = CMLib.lang().L("Troglodyte");
	...
	private final int[]	agingChart	= { 0, 1, 3, 12, 20, 53, 80, 90, 100 };
	...
	public List<RawMaterial> myResources()
	{
		synchronized(resources)
		{
			if(resources.size()==0)
			{
				...
				(L("a @x1 arm",name().toLowerCase()),RawMaterial.RESOURCE_MEAT));
				resources.addElement(makeResource
				(L("an aqua blue scale",name().toLowerCase()),RawMaterial.RESOURCE_SCALES));
				resources.addElement(makeResource
