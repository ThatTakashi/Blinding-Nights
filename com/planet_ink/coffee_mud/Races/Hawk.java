...
public class Hawk extends GreatBird
{
	...
	private final static String localizedStaticName = CMLib.lang().L("Hawk");
	...
	private final String[]	racialAbilityNames			= { "WingFlying", "GreatBirdSpeak", "Skill_RacialEnemy" };
	...
	private final String[]	racialAbilityParms			= { "", "", "Ophidian" };
