...
public class Snake extends StdRace
{
	...
	private final static String localizedStaticName = CMLib.lang().L("Snake");
	...
	private final String[]	racialAbilityNames			= { "SnakeSpeak", "Stigma", "Skill_AutoCrawl" };
	...
	public Weapon myNaturalWeapon()
	{
		if(naturalWeapon==null)
		{
			...
			naturalWeapon.setName(L("deadly fangs"));
