...
*/
public class OozeMephit extends Mephit
{
	@Override
	public String ID()
	{
	...
	public void affectCharStats(final MOB affectedMOB, final CharStats affectableStats)
	{
		...
		affectableStats.adjStat(CharStats.STAT_CONSTITUTION,-6);
	...
	private final String[]	racialAbilityParms			= { "ooze lesser" };
		...
		synchronized(resources)
		{
			if(resources.size()==0)
			{
				resources.addElement(makeResource
					(L("a pound of ooze"),RawMaterial.RESOURCE_SLIME));
			}
		}
		return resources;
	}
