...
public class SongBird extends StdRace
{
	...
	private final static String localizedStaticName = CMLib.lang().L("Song Bird");
	...
	{
		return ~(Wearable.WORN_EYES | Wearable.WORN_HEAD);
	}
	...
	public List<RawMaterial> myResources()
	{
		synchronized(resources)
		{
			if(resources.size()==0)
			{
				...
				(L("a @x1 voice box",name().toLowerCase()),RawMaterial.RESOURCE_MEAT));
				resources.addElement(makeResource
